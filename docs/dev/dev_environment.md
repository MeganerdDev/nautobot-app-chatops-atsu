...
- `project_name`: the default docker compose project name (default: `nautobot-chatops-atsu`)
...
Using **Invoke** these configuration options can be overridden using [several methods](https://docs.pyinvoke.org/en/stable/concepts/configuration.html). Perhaps the simplest is setting an environment variable `INVOKE_NAUTOBOT_CHATOPS_ATSU_VARIABLE_NAME` where `VARIABLE_NAME` is the variable you are trying to override. The only exception is `compose_files`, because it is a list it must be overridden in a YAML file. There is an example `invoke.yml` (`invoke.example.yml`) in this directory which can be used as a starting point.
...
#14 naming to docker.io/nautobot-chatops-atsu/nautobot:2.0.0-py3.11 done
```
...
Creating network "nautobot_chatops_atsu_default" with the default driver
Creating volume "nautobot_chatops_atsu_postgres_data" with default driver
Creating nautobot_chatops_atsu_redis_1 ...
Creating nautobot_chatops_atsu_docs_1  ...
Creating nautobot_chatops_atsu_postgres_1 ...
Creating nautobot_chatops_atsu_postgres_1 ... done
Creating nautobot_chatops_atsu_redis_1    ... done
Creating nautobot_chatops_atsu_nautobot_1 ...
Creating nautobot_chatops_atsu_docs_1     ... done
Creating nautobot_chatops_atsu_nautobot_1 ... done
Creating nautobot_chatops_atsu_worker_1   ...
Creating nautobot_chatops_atsu_worker_1   ... done
...
ee90fbfabd77   nautobot-chatops-atsu/nautobot:2.0.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_chatops_atsu_worker_1
b8adb781d013   nautobot-chatops-atsu/nautobot:2.0.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_chatops_atsu_nautobot_1
d64ebd60675d   nautobot-chatops-atsu/nautobot:2.0.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_chatops_atsu_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_chatops_atsu_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_chatops_atsu_redis_1
```
...
Stopping nautobot_chatops_atsu_worker_1   ...
Stopping nautobot_chatops_atsu_nautobot_1 ...
Stopping nautobot_chatops_atsu_docs_1     ...
Stopping nautobot_chatops_atsu_redis_1    ...
Stopping nautobot_chatops_atsu_postgres_1 ...
Stopping nautobot_chatops_atsu_worker_1   ... done
Stopping nautobot_chatops_atsu_nautobot_1 ... done
Stopping nautobot_chatops_atsu_postgres_1 ... done
Stopping nautobot_chatops_atsu_redis_1    ... done
Stopping nautobot_chatops_atsu_docs_1     ... done
Removing nautobot_chatops_atsu_worker_1   ...
Removing nautobot_chatops_atsu_nautobot_1 ...
Removing nautobot_chatops_atsu_docs_1     ...
Removing nautobot_chatops_atsu_redis_1    ...
Removing nautobot_chatops_atsu_postgres_1 ...
Removing nautobot_chatops_atsu_postgres_1 ... done
Removing nautobot_chatops_atsu_docs_1     ... done
Removing nautobot_chatops_atsu_worker_1   ... done
Removing nautobot_chatops_atsu_redis_1    ... done
Removing nautobot_chatops_atsu_nautobot_1 ... done
Removing network nautobot_chatops_atsu_default
```
...
So for example, our app is named `nautobot-chatops-atsu`, the command would most likely be `docker logs nautobot_chatops_atsu_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_chatops_atsu")
namespace.configure(
    {
        "nautobot_chatops_atsu": {
            ...
...
Or set the `INVOKE_NAUTOBOT_CHATOPS_ATSU_PYTHON_VER` variable.
...
Or set the `INVOKE_NAUTOBOT_CHATOPS_ATSU_NAUTOBOT_VER` variable.
...
In the package source, there is the `nautobot_chatops_atsu/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
