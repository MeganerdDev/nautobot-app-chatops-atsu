...
# NOTE: based on https://github.com/nautobot/nautobot-app-chatops/blob/develop/nautobot_chatops/views.py


class AtsuCommandViewSet(ViewSet):
    """UI viewset for the atsu chatops App."""
    lookup_value_regex = "[^/]+"

    def list(self, request):
        """GET /atsu/ landing page."""
        return Response({"message": "atsu chatops ui root"})

    @action(detail=False, url_path="installed-plugins")
    def installed_plugins(self, request):
        """GET /atsu/installed-plugins/."""
